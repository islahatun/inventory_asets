...
<head>
    ...
    <title>Laporan Jumlah Barang Keluar</title>
</head>
    ...
    <table style="border-collapse: collapse; width: 100%;">
        <tr>
            ...
            <td style="padding: 10px;">
                <h1 style="text-align: center">PEMERINTAH KOTA CILEGON</h1>
                <h2 style="text-align: center">KECAMATAN CIBEBER</h2>
                <p style="text-align: center">Jl. Kedung Baya No. 1 Telp :(0254)385869 Kel. Kalitimbang Kec. Cibeber</p>
            </td>
        </tr>
    </table>

    <h3 align="center">LAPORAN JUMLAH BARANG KELUAR</h3>
    <div>
        <table border="1" cellspasing="0" cellpadding="3">
            <thead>
                <tr>
                    <td>No</td>
