...
@push('scripts')
    ...
    <script>
        ...
        method = 'POST';
        formUrl= "{{ route('departement.store') }}"
        ...
        function edit(obj) {
            ...
            method = 'POST';
            formUrl= "{{ route('departement.update') }}";
                            ...
                            Swal
                                ...
                                .then((result) => {
                                    if (result.isConfirmed) {
                                        $.ajax({
                                            url:  "{{ route('departement.destroy', ':id') }}".replace(':id', data.id),
                                            type: "DELETE",
                                            cache: false,
                                            data: {
                                                "_token": "{{ csrf_token() }}"
